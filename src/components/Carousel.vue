<template>
  <div id="home" v-if="data?.length"  class="carousel carousel-dark slide scrollElement" data-bs-ride="carousel" data-bs-pause="false">
    <div class="carousel-indicators">
      <button v-for="(item,index) in data" :key="index" type="button" data-bs-target="#home" :data-bs-slide-to="index" :class="{'active': index == 0}"  aria-current="true" :aria-label="'Slide '+index"></button>
    </div>
